  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Content
        maxWidth="500px"
        maxHeight="700px"
        className={`!backdrop-blur-sm !border-0 !rounded-3xl !shadow-2xl !overflow-hidden ${isDark ? "!bg-gray-800/95" : "!bg-white/95"
          }`}
      >
          ...
          <form onSubmit={handleSubmit} className="!space-y-4">
            ...
            >
              ...
              <Button
                type="submit"
                disabled={loading}
                className={`!bg-gradient-to-r !from-blue-500 !to-purple-600 !text-white !rounded-xl ${loading && "!cursor-not-allowed"
                  }`}
              >
